...
export const metadata: Metadata = {
  title: "Oluwasusi Stephen Olayemi",
  description: "I design and build beautiful, functional websites that merge creativity with purpose. Every project is an opportunity to push boundaries and create something memorable.",
};
